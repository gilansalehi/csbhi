  ...
  },
  {
    ...
    cards: [
      ...
      cascade({
        ...
        note: String.raw`Once the reciprocal handoff and Friedmann ledger are supplied, \(\dot\Gamma_{\rm GD}/\Gamma_{\rm GD}=2H\) closes its mature evolution. This is a ruler-scale ratio, not automatically a four-metric Weyl factor or null affine-transfer factor. Misner–Sharp notes also use \(\Gamma=D_\ell R\), so subscripts are mandatory.`,
      ...
      cascade({
        ...
        note: String.raw`Where a genuine local Weyl map exists, it scales mapped proper times and affine null parameters. The throat has not yet proved \(\Omega_{\rm W}=\Gamma_{\rm GD}\).`,
