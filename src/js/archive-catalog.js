...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      note('Marginality Transfer and the Reciprocal Cosmological Clock in Spherical Black-Hole–FLRW Matching', 'marginality_transfer_and_reciprocal_cosmological_clock'),
