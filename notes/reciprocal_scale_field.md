...
1. **Shear-free Weyl closure [solved].** [A Black Hole on the Aeon Boundary](note.html?src=shear_free_interior_weyl_stress_identity) fixes the transverse stress a shear-free reciprocal interior requires, \(\Pi=-\tfrac12 D\), and identifies its Weyl dilution \(a^{-2}\) as the conformal weight that keeps the aeon boundary regular. The non-geodesic, pressure-supported throat and its Darmois data remain open.
