...
16. [CSBHI Mini-Program — Level 5 Setup](note.html?src=level_5_event_horizon_creases_and_rotation_test).
17. [CSBHI Formation Mini-Program — Level 5 Conditional Result and Campaign Summary](note.html?src=level_5_rotation_and_campaign_summary).
18. [Audit of the Oppenheimer–Snyder Formation Map](note.html?src=os_formation_conformal_map_audit).
