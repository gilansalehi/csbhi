...
The two relations in (1) are different in kind and must not be conflated. The first is a *covariance* statement — how a geometric entropy transforms under the reciprocal rescaling. The second is a *dynamical* statement — that the interior's late-time gravitational entropy approaches the Gibbons–Hawking de Sitter value [3]. The proposal is that the reciprocal scaling interpolates the former into the latter.
